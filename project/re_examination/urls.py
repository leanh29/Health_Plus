...
from . import views
from .views import GetReExaminationList, save_re_examination, update_re_examination, delete_re_examination, GetReExaminationDetail, save_medical_detail, get_re_examination_detail
...
urlpatterns = [
    ...
    path('list/<int:hospital_record_id>/detail/<int:id>/', get_re_examination_detail, name='re_examination_detail'),
    ...
    path('list/<int:hospital_record_id>/detail/<int:id>/detail-medical-detail/<int:medical_id/', GetReExaminationDetail.as_view(), name='medical_detail_detail'),
